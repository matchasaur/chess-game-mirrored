...
TEST(PLAYER, SIMPLETEST1) {
  ...
  EXPECT_EQ("Player JIMMY is now unranked. JIMMY is a Human Player with a winrate of 0.000000 in 0 games", a -> print_status());
...
TEST(PLAYER, SIMPLETEST2) {
  ...
  EXPECT_EQ("JIMMY", a -> get_name());
  EXPECT_EQ("Player JIMMY is now unranked. JIMMY is a Computer Player with a winrate of 0.000000 in 0 games", a -> print_status());
...
TEST(PLAYERLIST, HarderTest1) {
  ...
  a -> set_color(Black);
  EXPECT_EQ(Black, a -> get_color());
  EXPECT_EQ("Player JIMMY is now unranked. JIMMY is a Human Player with a winrate of 0.000000 in 0 games\nPlayer JIMMY is now unranked. JIMMY is a Computer Player with a winrate of 0.000000 in 0 games\n", Sum_List -> print_list());
  delete a;
  delete b;
  delete Sum_List;
...
TEST(GetPlayerFromList, EvenHardestTest3) // turns out this is not doable
{
  ...
  EXPECT_EQ("Player JIMMY is now unranked. JIMMY is a Human Player with a winrate of 0.000000 in 0 games\nPlayer ALLEN is now unranked. ALLEN is a Computer Player with a winrate of 0.000000 in 0 games\nPlayer Dola is now unranked. Dola is a Computer Player with a winrate of 0.000000 in 0 games\n", Sum_List -> print_list());
